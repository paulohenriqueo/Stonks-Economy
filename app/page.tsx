...
export default function Home() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-100 via-sky-100 to-blue-100 dark:from-zinc-900 dark:via-zinc-950 dark:to-black font-sans">
      <main className="flex flex-col items-center justify-center w-full max-w-2xl rounded-3xl shadow-xl bg-white/90 dark:bg-zinc-900/90 p-10 sm:p-16 gap-10 border border-zinc-200 dark:border-zinc-800">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
          <button className="w-full sm:w-auto px-8 py-3 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold shadow transition-colors">
            Entrar
          </button>
